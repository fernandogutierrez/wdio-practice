exports.config = {
    ...
    cucumberOpts: {
        ...
        snippets: true,     // <boolean> hide step definition snippets for pending step_definitions
        source: true,       // <boolean> hide source uris
        profile: [],        // <string[]> (name) specify the profile to use
        strict: false,      // <boolean> fail if there are any undefined or pending step_definitions
